            ...
            <div className="accordion" id="accordionExample">
                <div className="accordion-item">
                    <h2 className="accordion-header" id="headingOne">
                        <button className="accordion-button" type="button" style={myStyles} data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                            Accordion Item #1
                        </button>
                    </h2>
                    <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                        <div className="accordion-body" style={myStyles}>
                            <strong>Lorem, ipsum dolor sit amet consectetur</strong> adipisicing elit. Blanditiis molestiae porro aut quis, delectus, nesciunt consequuntur distinctio maiores nam, praesentium deleniti! Veritatis vel, minus quasi reprehenderit culpa corrupti aliquid at? <code>.accordion-body</code>, though the transition does limit overflow.
                        </div>
                    </div> 
                </div>
                <div className="accordion-item">
